...
class ModuleCard(FloatLayout):
    ...
    def __init__(self, **kwargs):
        ...
        # module labels
        self.module_id = self.generateCardLabel('Module '+kwargs["module"].get("id"), \
          module_card_style["module_font"], module_card_style["id_y"])
        self.module_name = self.generateCardLabel(kwargs["module"].get("name"), \
          module_card_style["module_font"], module_card_style["name_y"])

        # add widgets (all labels, buttons, etc) to the screen
        self.add_widget(self.module_id)
        self.add_widget(self.module_name)
